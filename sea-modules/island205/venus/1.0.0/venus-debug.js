...
define("island205/venus/1.0.0/vango-debug", [], function(require, exports, module) {
    ...
    (function(root, factory) {
        ...
        var __hasProp = Object.prototype.hasOwnProperty, DOC = document, PI = Math.PI, guid = 0, vangoprop = Vango.prototype, defaultOptions = {
            fill: true,
            stroke: false
        }, __animate;
        __animate = function() {
            ...
            animate = function(duration, callback) {
                var finished, startTime, step, that = this;
                startTime = new Date();
                finished = -1;
	...
	*/
        ...
        Vango.extend({
            ...
            ellipse: function(x, y, radiusX, radiusY, options) {
                ...
                __styleFillAndStroke.call(this, options, function() {
                    ...
                    that.bezierCurveTo(x + radiusX, y - radiusY, x + radiusX, y + radiusY, x, y + radiusY);
                    that.bezierCurveTo(x - radiusX, y + radiusY, x - radiusX, y - radiusY, x, y - radiusY);
                    that.closePath();
                });
                return this;
            ...
            polygon: function(x, y, n, radius, angle, counterclockwise, options) {
                ...
                __styleFillAndStroke.call(this, options, function() {
                    ...
                    that.moveTo(x + radius * Math.sin(angle), y - radius * Math.cos(angle));
                    ...
                    for (var i = 1; i < n; i++) {
                        ...
                        that.lineTo(x + radius * Math.sin(angle), y - radius * Math.cos(angle));
                    }
                    that.closePath();
                });
                return this;
		...
		*/
            path: function(pathString, options) {
                var that = this, ca = _getDataArray(pathString);
                __styleFillAndStroke.call(this, options, function() {
                    that.beginPath();
        ...
        (function() {
            ...
            Vango.extend({
                on: function(type, listener) {
                    var cvs = this.canvas, that = this, _listener;
